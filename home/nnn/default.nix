{
  ...
  nnn = pkgs.writeShellScriptBin "nnn" ''
    export NNN_PLUG='f:finder;o:fzopen;p:mocplay;d:diffs;m:nmount;v:imgview;r:renamer;c:.cbcp;s:-!echo $PWD/$nnn|xclip -sel c*;h:-!hx $nnn*;t:-!~/wks/nixconfig-starter/scripts/helix-open $PWD/$nnn*'
